...
import { UserRegisterSchema, registerUserSchema } from '@/utils/zod';
...
export default function SignUpForm() {
    ...
    const [form, setForm] = useState<UserRegisterSchema>({
        firstName: "",
        lastName: "",
        email: "",
        password: ""
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-6 items-center px-6 md:px-12'>
                <div className='flex flex-col items-center'>
                    ...
                    <h2 className=" text-lg font-medium text-gray-700">
                        Welcome! You can be better without us!
                    </h2>
                </div>
                ...
                <div className='w-full flex flex-col gap-3'>
                    <div className='flex gap-2'>
                        <div className='flex flex-col w-1/2'>
                            <label htmlFor='firstName' className='font-medium text-black'>First Name<span className='text-red-500 pl-1'>*</span></label>
                            <Input
                                id="firstName"
                                type="text"
                                placeholder="Alex"
                        ...
                        <div className='flex flex-col w-1/2'>
                            <label htmlFor='lastName' className='font-medium text-black'>Last Name<span className='text-red-500 pl-1'>*</span></label>
                            <Input
                                id="lastName"
                                type="text"
                                placeholder="Repeta"
                ...
                <div>
                    <p>Already have an account? <Link href={'/auth/signin'} className='text-blue-500 font-medium transition duration-300  hover:underline hover:text-blue-600'>Sign In</Link></p>
                </div>
            </form>
        </div>
    );
